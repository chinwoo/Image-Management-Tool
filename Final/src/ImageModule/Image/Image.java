...
public class Image {
     ...
     *   position. This method can also be used to create image mosiacs.
     */
    public void addImage(ImageModule.Image.Image in, int x, int y, boolean expand){
    ...
    */
    ...
    public boolean equals(Object obj){
        if (obj!=null){
            if (obj instanceof ImageModule.Image.Image){
                ImageModule.Image.Image image = (ImageModule.Image.Image) obj;
...
//***************************************************************************
    ...
    private class Skew {
        ...
        public Skew(ImageModule.Image.Image src) {
