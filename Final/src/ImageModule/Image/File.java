...
public class File implements Comparable {
     ...
     *  file is returned.
     */
    public ImageModule.Image.File moveTo(Directory Destination){
        return moveTo(new ImageModule.Image.File(Destination, getName()), true);
    }
     ...
     *  file is returned.
     */
    public ImageModule.Image.File moveTo(ImageModule.Image.File Destination, boolean Overwrite){
     ...
     *  successfully.
     */
    public boolean copyTo(ImageModule.Image.File Destination, boolean Overwrite){
     ...
     */
    public ImageModule.Image.File rename(String FileName){
        if (FileName!=null){
    ...
    public org.w3c.dom.Document getXML(){
        ...
        try{
            is = getInputStream();
            org.w3c.dom.Document xml = ImageModule.Image.DOM.createDocument(is);
            is.close();
            return xml;
        }
        catch(Exception e){
    ...
    public void write(org.w3c.dom.Document xml){
        write(ImageModule.Image.DOM.getText(xml), xml.getXmlEncoding());
    }
    ...
    public boolean equals(Object obj){
        if (obj instanceof ImageModule.Image.File || obj instanceof java.io.File){
    ...
    protected static synchronized boolean loadDLL(){
        ...
        if (isWindows){
            ...
            if (dllLoaded==null){ //haven't tried to load the dll yet...
                ...
                ImageModule.Image.Directory dir = new ImageModule.Image.Directory(System.getProperty("user.home"));
                for (String appDir : new String[]{"AppData\\Local", "Application Data"}){
                    ImageModule.Image.Directory d = new ImageModule.Image.Directory(dir + appDir);
                ...
                if (line!=null){
                    ...
                    if (arr.length>7){
                        try{
                            ...
                            return new ImageModule.Image.Date(date, "yyyy-MM-dd HH:mm:ss z").getDate();
                        }
                        catch(Exception e){
                        }
                    }
                ...
                if (line!=null){
                    ...
                    if (arr.length>10){
                        try{
                            ...
                            return new ImageModule.Image.Date(date, "MMM dd hh:mm:ss yyyy").getDate();
                        }
                        catch(Exception e){
                        }
                    }
